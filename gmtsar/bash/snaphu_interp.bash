...
if [ $# -lt 2 ]; then
  errormessage:
  echo ""
  echo "snaphu_interp.bash [GMTSAR] - Unwrap the phase with nearest neighbor interpolating low coherence and blank pixels"
  echo " "
  echo "Usage: snaphu_interp.bash correlation_threshold maximum_discontinuity [<rng0>/<rngf>/<azi0>/<azif>]"
  echo ""
  ...
  echo "       maximum_discontinuity=0 for continuous phase such as interseismic "
  echo ""
