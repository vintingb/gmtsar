...
extern int rec_stop;
extern /* End new parameters 4/23/97 -EJP */
...
extern int ref_identity;      /* (1)-ERS1 (2)-ERS2 (3)-Radarsat (4)-Envisat (5)-ALOS
                          (6)-Envisat_SLC  (7)-TSX (8)-CSK (9)-RS2 (10)-S1A*/
...
extern /* End new parameters 4/23/97 -DTS */
...
extern double B_offset_start;
extern double B_offset_center;
extern double B_offset_end;
